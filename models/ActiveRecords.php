...
use PDO;
    ...
    class ActiveRecords{
        ...
        */
        ...
        /** Inserta los elementos en la base de datos cuando tienen un campo autoincrmenetal
        ...
        */
         ...
         * @return array Resultado en forma de array asociativo
        */
        public function selectPaginacion($campo, $dato, $iniciar, $articulosPorPagina){
        ...
        /**
         * Consulta para leer x cantidad de libros
         * @param int $limit Número de libros que quiere recoger
         * @return array Resultado en forma de array asociativo
        */
        public function selectLimit($campo, $dato, $limit) {
            $query = "SELECT * FROM " . static::$tabla . " WHERE " . $campo . " = " . $dato . " ORDER BY id_libro DESC LIMIT " . $limit;
            $resultado = self::consultarSQL($query);
            return $resultado;
        }
        ...
        */
        ...
        public static function recuentoLibros() {
            
            $query = "SELECT c.nombre_categoria, COUNT(l.id_libro) AS num_libros FROM categoria c LEFT JOIN libro l ON c.id_categoria = l.id_categoria GROUP BY c.id_categoria;";
        ...
        //     $existeArchivo = file_exists(CARPETA_IMAGENES . $this->icono_categoria);
        //     if($existeArchivo) {
