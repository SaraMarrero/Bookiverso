    ...
    class LoginRegisterController{
        ...
        public static function register(Router $router){
            ...
            if($_SERVER['REQUEST_METHOD'] === 'POST'){
                ...
                $queryDNI = $usuario->selectEspecifico('dni_usuario', "'$usuario->dni_usuario'");
        ...
        public static function login(Router $router){
            ...
            if($_SERVER['REQUEST_METHOD'] === 'POST'){
                ...
                if(empty($errores)){
                    ...
                    $queryEmail = $usuario->selectEspecifico('email_usuario', "'$usuario->email_usuario'");
                    
                    if(count($queryEmail) !== 0){
                        // Verifica la contraseña
                        $dato = $queryEmail[0];
        
                        $passwordCifrada = password_verify($usuario->password_usuario, $dato['password_usuario']);
