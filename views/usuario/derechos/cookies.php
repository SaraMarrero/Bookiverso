...
<main style="background: rgba(4, 120, 87);">
    ...
    <div class="text-center w-4/5 m-auto">
        <h1 class="font-bold text-white text-3xl text-white">Política de cookies</h1>
        ...
        <p class="text-white">
            ...
            Entidad Responsable
            La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página Bookiverso, propiedad de Sara Marrero Mirada | Alejandro Domínguez Carreño – Calle Proyecto Final.
            ...
            Las cookies, en función de su permanencia, pueden dividirse en cookies de sesión o permanentes. Las que expiran cuando el usuario cierra el navegador. Las que expiran en función de cuando se cumpla el objetivo para el que sirven (por ejemplo, para que el usuario se mantenga identificado en los servicios de Sara Marrero Mirada | Alejandro Domínguez Carreño) o bien cuando se borran manualmente.
            ...
            Cada vez que un usuario visita un servicio, una herramienta de un proveedor externo genera una cookie analítica en el ordenador del usuario. Esta cookie que sólo se genera en la visita, servirá en próximas visitas a los servicios de Sara Marrero Mirada | Alejandro Domínguez Carreño para identificar de forma anónima al visitante. Los objetivos principales que se persiguen son:
            ...
            Importante: Salvo que el usuario decida registrarse en un servicio de Sara Marrero Mirada | Alejandro Domínguez Carreño, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.

            Cookies de publicidad
            Este tipo de cookies permiten ampliar la información de los anuncios mostrados a cada usuario anónimo en los servicios de Sara Marrero Mirada | Alejandro Domínguez Carreño. Entre otros, se almacena la duración o frecuencia de visualización de posiciones publicitarias, la interacción con las mismas, o los patrones de navegación y/o comportamientos del usuario ya que ayudan a conformar un perfil de interés publicitario. De este modo, permiten ofrecer publicidad afín a los intereses del usuario.

            Cookies publicitarias de terceros
            Además de la publicidad gestionada por las webs de Sara Marrero Mirada | Alejandro Domínguez Carreño en sus servicios, las webs de Sara Marrero Mirada | Alejandro Domínguez Carreño ofrecen a sus anunciantes la opción de servir anuncios a través de terceros (“Ad-Servers”). De este modo, estos terceros pueden almacenar cookies enviadas desde los servicios de Sara Marrero Mirada | Alejandro Domínguez Carreño procedentes de los navegadores de los usuarios, así como acceder a los datos que en ellas se guardan.

            Las empresas que generan estas cookies tienen sus propias políticas de privacidad. En la actualidad, las webs de Sara Marrero Mirada | Alejandro Domínguez Carreño utilizan la plataforma Doubleclick (Google) para gestionar estos servicios. Para más información, acuda a
            ...
            Las webs de Sara Marrero Mirada | Alejandro Domínguez Carreño pueden modificar esta Política de Cookies en función de exigencias legislativas, reglamentarias, o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia Española de Protección de Datos, por ello se aconseja a los usuarios que la visiten periódicamente.
