...
<main style="background: rgba(4, 120, 87);">
    ...
    <div class="text-center w-4/5 m-auto">
        <h1 class="font-bold text-white text-3xl text-white">CONDICIONES GENERALES DE VENTA</h1>

        <p class="text-white">
            Bookiverso
            1. INFORMACIÓN GENERAL
            La titularidad de este sitio web Bookiverso, (en adelante Sitio Web) la ostenta: , y cuyos datos de contacto son:

            Dirección: Calle Proyecto

            Teléfono de contacto: 111 111 111

            Email de contacto: saramarreromiranda@gmail.com

            Este documento (así como otros documentos que aquí se mencionen) regula las condiciones por las que se rige el uso de este Sitio Web (Bookiverso) y la compra o adquisición de productos y/o servicios en el mismo (en adelante, Condiciones).

            A efectos de estas Condiciones se entiende que la actividad que https://bookiverso.com desarrolla a través del Sitio Web comprende:

            Venta de libros electrónicos gratis

            Además de leer las presentes Condiciones, antes de acceder, navegar y/o usar esta página web, el Usuario ha de haber leído el Aviso Legal y las Condiciones Generales de Uso, incluyendo, la política de cookies, y la política de privacidad y de protección de datos de https://bookiverso.com. Al utilizar este Sitio Web o al hacer y/o solicitar la adquisición de un producto y/o servicio a través del mismo el Usuario consiente quedar vinculado por estas Condiciones y por todo lo anteriormente mencionado, por lo que si no está de acuerdo con todo ello, no debe usar este Sitio Web.
            ...
            El Usuario podrá formalizar, a su elección, con https://bookiverso.com el contrato de compraventa de los productos y/o servicios deseados en cualquiera de los idiomas en los que las presentes Condiciones estén disponibles en este Sitio Web.

            3. PROCESO DE COMPRA O ADQUISICIÓN
            Los Usuarios debidamente registrados pueden comprar en el Sitio Web por los medios y formas establecidos. Deberán seguir el procedimiento de compra y/o adquisición online de Bookiverso, durante el cual varios productos y/o servicios pueden ser seleccionados y añadidos al carrito, cesta o espacio final de compra y, finalmente, hacer clic en: "Descargar"
            ...
            Seguidamente, el Usuario recibirá un correo electrónico confirmando que https://bookiverso.com ha recibido su pedido o solicitud de compra y/o prestación del servicio, es decir, la confirmación del pedido. Y, en su caso, se le informará, igualmente, mediante correo electrónico cuando su compra esté siendo enviada. En su caso, estas informaciones también podrían ponerse a disposición del Usuario a través de su espacio personal de conexión al Sitio Web.

            Una vez el procedimiento de compra ha concluido, el Usuario consiente que el Sitio Web genere una factura electrónica que se hará llegar al Usuario a través del correo electrónico y en su caso, a través de su espacio personal de conexión al Sitio Web. Asimismo, el Usuario puede, si así lo desea, obtener una copia de su factura en papel, solicitándolo a https://bookiverso.com utilizando los espacios de contacto del Sitio Web o a través de los datos de contacto facilitados más arriba.
            ...
            Las tarjetas de crédito estarán sujetas a comprobaciones y autorizaciones por parte de la entidad bancaria emisora de las mismas, si dicha entidad no autorizase el pago, https://bookiverso.com no será responsable por ningún retraso o falta de entrega y no podrá formalizar ningún contrato con el Usuario.

            Una vez que https://bookiverso.com reciba la orden de compra por parte del Usuario a través del Sitio Web, se hará una pre-autorización en la tarjeta que corresponda para asegurar que existen fondos suficientes para completar la transacción. El cargo en la tarjeta se hará en el momento en que se envíe al Usuario la confirmación de envío y/o confirmación del servicio que se presta en forma y, en su caso, lugar establecidos.

            En todo caso, al hacer clic en "Descargar" el Usuario confirma que el método de pago utilizado es suyo.
            ...
            Si por algún motivo, que le fuera imputable, https://bookiverso.com no pudiera cumplir con la fecha de entrega, contactará al Usuario para informarle de esta circunstancia y, éste podrá elegir seguir adelante con la compra estableciendo una nueva fecha de entrega o bien anular el pedido con el reembolso total del precio pagado. En cualquier caso, las entregas a domicilio se realizan en días laborables.
            ...
            Los riesgos que de los productos se pudieran derivar serán a cargo del Usuario a partir del momento de su entrega. El Usuario adquiere la propiedad de los productos cuando https://bookiverso.com recibe el pago completo de todas las cantidades debidas en relación a la compra o adquisición efectuada, incluidos los gastos de envío, o bien en el momento de la entrega, si ésta tiene lugar en un momento posterior a la recepción completa del importe objeto de pago por https://bookiverso.com.
            ...
            Se pone en conocimiento del Usuario que en caso de que detecte que se ha producido un error al introducir datos necesarios para procesar su solicitud de compra en el Sitio Web, podrá modificar los mismos poniéndose en contacto con https://bookiverso.com a través de los espacios de contacto habilitados en el Sitio Web, y, en su caso, a través de aquellos habilitados para contactar con el servicio de atención al cliente, y/o utilizando los datos de contacto facilitados en la cláusula primera (Información general). Asimismo, estas informaciones también podrían subsanarse por el Usuario a través de su espacio personal de conexión al Sitio Web.

            En cualquier caso, el Usuario, antes de hacer clic en "Descargar", tiene acceso al espacio, carrito, o cesta donde se van anotando sus solicitudes de compra y puede hacer modificaciones.
            ...
            En caso de desistimiento, https://bookiverso.com reembolsará al Usuario todos los pagos recibidos, incluidos los gastos de envío (con la excepción de los gastos adicionales elegidos por el Usuario para una modalidad de envío diferente a la modalidad menos costosa ofrecida en el Sitio Web) sin ninguna demora indebida y, en todo caso, a más tardar en 14 días naturales a partir de la fecha en la que https://bookiverso.com es informado de la decisión de desistir por el Usuario.

            https://bookiverso.com reembolsará al Usuario utilizando el mismo método de pago que empleó este para realizar la transacción inicial de compra. Este reembolso no generará ningún coste adicional al Usuario. No obstante, https://bookiverso.com podría retener dicho reembolso hasta haber recibido los productos o artículos de la compra, o hasta que el Usuario presente una prueba de la devolución de los mismos, según qué condición se cumpla primero.

            El Usuario puede devolver o enviar los productos a https://bookiverso.com en:

            Y deberá hacerlo sin ninguna demora indebida y, en cualquier caso, a más tardar en el plazo de 14 días naturales a partir de la fecha en que https://bookiverso.com fue informado de la decisión de desistimiento.
            ...
            En este mismo sentido se rige la prestación de un servicio que el Usuario pudiera contratar en este Sitio Web, pues esta misma Ley establece que no asistirá el Derecho de desistimiento a los Usuarios cuando la prestación del servicio ha sido completamente ejecutada, o cuando haya comenzado, con el consentimiento expreso del consumidor y usuario y con el reconocimiento por su parte de que es consciente de que, una vez que el contrato haya sido completamente ejecutado por https://bookiverso.com, habrá perdido su derecho de desistimiento.
            ...
            Salvo disposición legal en sentido contrario, https://bookiverso.com no aceptará ninguna responsabilidad por las siguientes pérdidas, con independencia de su origen:
            ...
            De esta forma, las obligaciones quedarán suspendidas durante el periodo en que la causa de fuerza mayor continúe, y https://bookiverso.com dispondrá de una ampliación en el plazo para cumplirlas por un periodo de tiempo igual al que dure la causa de fuerza mayor. https://bookiverso.com pondrá todos los medios razonables para encontrar una solución que le permita cumplir con sus obligaciones a pesar de la causa de fuerza mayor.

            10. COMUNICACIONES POR ESCRITO Y NOTIFICACIONES
            Mediante el uso de este Sitio Web, el Usuario acepta que la mayor parte de las comunicaciones con https://bookiverso.com sean electrónicas (correo electrónico o avisos publicados en el Sitio Web).

            A efectos contractuales, el Usuario consiente en usar este medio electrónico de comunicación y reconoce que todo contrato, notificación, información y demás comunicaciones que https://bookiverso.com envíe de forma electrónica cumplen con los requisitos legales de ser por escrito. Esta condición no afectará a los derechos reconocidos por ley al Usuario.

            El Usuario puede enviar notificaciones y/o comunicarse con https://bookiverso.com a través de los datos de contacto que en estas Condiciones se facilitan y, en su caso, a través de los espacios de contacto del Sitio Web.

            Igualmente, salvo que se estipule lo contrario, https://bookiverso.com puede contactar y/o notificar al Usuario en su correo electrónico o en la dirección postal facilitada.

            11. RENUNCIA
            Ninguna renuncia de https://bookiverso.com a un derecho o acción legal concreta o la falta de requerimiento por https://bookiverso.com del cumplimiento estricto por el Usuario de alguna de sus obligaciones supondrá, ni una renuncia a otros derechos o acciones derivados de un contrato o de las Condiciones, ni exonerará al Usuario del cumplimiento de sus obligaciones.

            Ninguna renuncia de https://bookiverso.com a alguna de las presentes Condiciones o a los derechos o acciones derivados de un contrato surtirá efecto, a no ser que se establezca expresamente que es una renuncia y se formalice y se le comunique al Usuario por escrito.
            ...
            13. ACUERDO COMPLETO
            Las presentes Condiciones y todo documento al que se haga referencia expresa en estas constituyen el acuerdo íntegro existente entre el Usuario y https://bookiverso.com en relación con el objeto de compraventa y sustituyen a cualquier otro pacto, acuerdo o promesa anterior convenida verbalmente o por escrito por las mismas partes.

            El Usuario y https://bookiverso.com reconocen haber consentido la celebración de un contrato sin haber confiado en ninguna declaración o promesa hecha por la otra parte, salvo aquello que figura expresamente mencionado en las presentes Condiciones.

            14. PROTECCIÓN DE DATOS
            La información o datos de carácter personal que el Usuario facilite a https://bookiverso.com en el curso de una transacción en el Sitio Web, serán tratados con arreglo a lo establecido en la Política de Privacidad o de protección de datos (contenida, en su caso, en el Aviso Legal y Condiciones Generales de Uso). Al acceder, navegar y/o usar el Sitio Web el Usuario consiente el tratamiento de dicha información y datos y declara que toda la información o datos que facilita son veraces.
            ...
            Cualquier controversia, problema o desacuerdo que surja o este relacionado con el acceso, navegación y/o uso del Sitio Web, o con la interpretación y ejecución de estas Condiciones, o con los contratos de venta entre https://bookiverso.com y el Usuario, será sometida a la jurisdicción no exclusiva de los juzgados y tribunales españoles.

            16. QUEJAS Y RECLAMACIONES
            El Usuario puede hacer llegar a https://bookiverso.com sus quejas, reclamaciones o todo otro comentario que desee realizar a través de los datos de contacto que se facilitan al principio de estas Condiciones (Información General).

            Además, https://bookiverso.com dispone de hojas oficiales de reclamación a disposición de los consumidores y usuarios, y que estos pueden solicitar a https://bookiverso.com en cualquier momento, utilizando los datos de contacto que se facilitan al principio de estas Condiciones (Información General).

            Asimismo, si de la celebración de este contrato de compra entre https://bookiverso.com y el Usuario emanara una controversia, el Usuario como consumidor puede solicitar una solución extrajudicial de controversias, de acuerdo con el Reglamento (UE) 524/2013 del Parlamento Europeo y del Consejo, de 21 de mayo de 2013, sobre resolución de litigios en línea en materia de consumo y por el que se modifica el Reglamento (CE) 2006/2004 y la Directiva 2009/22/CE. Puede acceder a este método a través del siguiente sitio web: https://ec.europa.eu/consumers/odr/.
