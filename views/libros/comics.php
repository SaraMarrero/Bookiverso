<?php
    ...
    if(!$_GET){
        header('Location: /libros/Comics?pagina=1');
    }
...
<section class="bg-gradient-to-r from-gray-900 via-purple-700 to-gray-900">

	<main class="w-4/6 m-auto bg-red-950">
		<h1 class="text-center p-5 font-bold text-3xl text-gray-200">Cómics</h1>
				...
				foreach($result as $index => $datosLibro){ ?>
					...
					<div class="rounded-lg shadow-lg m-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 bg-white relative pb-10 hover:shadow-2xl" style="overflow: hidden;">
						<div style="position: relative;">
							<img class="w-full m-auto relative rounded-lg" src="../build/img/libros/comics/<?php echo $datosLibro['foto_libro']; ?>" alt="<?php echo $datosLibro['nombre_libro']; ?>">
							...
							<div class="relative p-4 w-full max-w-2xl max-h-full">
								...
								<div class="relative bg-white rounded-lg shadow">
									...
									<div class="p-4 md:p-5 space-y-4 flex content-center">
										<div class="w-1/4">
											<img class="w-full h-full m-auto" src="../build/img/libros/comics/<?php echo $datosLibro['foto_libro']; ?>" alt="<?php echo $datosLibro['nombre_libro']; ?>">
										</div>
		...
		<nav class="content-center">
			<ul class="inline-flex -space-x-px">
				...
				<li>
					<a href="/libros/Comics?pagina=<?php echo $_GET['pagina'] <= 1 ? $_GET['pagina'] : $_GET['pagina']-1; ?>"
				...
				<?php for($i = 1; $i <= $paginas; $i++){ ?>
					<li <?php echo $_GET['pagina'] == $i ? 'class="font-bold text-purple-900"' : 'class="text-gray-500"' ?>>
						<a href="/libros/Comics?pagina=<?php echo $i ?>""
				...
				<li>
					<a href="/libros/Comics?pagina=<?php echo $_GET['pagina'] >= $paginas ? $_GET['pagina'] : $_GET['pagina']+1; ?>" class="bg-white border border-gray-300 text-gray-500 hover:bg-gray-100 hover:text-gray-700 rounded-r-lg leading-tight py-2 px-3">Siguiente</a>
				</li>
			</ul>
		</nav>
