<main class="w-full bg-blue-900">
	<h1 class="text-center py-16 font-bold text-2xl text-white tracking-wider">Romance</h1>
			...
			<tbody>
				...
				?>
					...
					<tr class="bg-white border-b hover:bg-gray-50">
						<td class="py-4">
							<img src="/build/img/libros/romance/<?php echo $libro['foto_libro']; ?>" alt="<?php echo $libro['foto_libro']; ?>" class="w-16 md:w-32 max-w-full max-h-full m-auto">
						</td>
